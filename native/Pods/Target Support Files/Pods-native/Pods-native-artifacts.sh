...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../../flutter_module/.ios/Flutter/engine/Flutter.xcframework" "" "true" "ios-x86_64-simulator/Flutter.framework" "ios-armv7_arm64/Flutter.framework"
fi
